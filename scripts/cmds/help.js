...
const doNotDelete = "[ ☀︎︎ | ☻︎𝐀𝐘𝐀𝐍☻︎ ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
...
module.exports = {
	...
	onStart: async function ({ message, args, event, threadsData, role }) {
		...
		if (args.length === 0) {
			...
			msg += `░░░░█▄█ ▄▀█ ▀█ █▄▀ █▄█░░░
░░░░░█░ █▀█ █▄ █░█ ░█░░░░\n\n◦❭❯❱ 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 & 𝗖𝗔𝗧𝗘𝗚𝗢𝗥𝗬 ❰❮❬◦\n\n[.]𝐀𝐑𝐈𝐘𝐀𝐍•🅱🅾🆃↠ 𝐒𝐀𝐌_®`; // replace with your name 
			...
			msg += `☀︎︎ | ☻︎𝐀𝐘𝐀𝐍☻︎`; // its not decoy so change it if you want 
