...
const doNotDelete = "[ ☀︎︎ | ☻︎𝖲 𝖠 𝖭 𝖭 𝖸☻︎ ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy

module.exports = {
	config: {
		name: "help",
		version: "1.17",
		author: "NTKhang | AYAN", // original author Kshitiz 
		countDown: 5,
		role: 0,
		shortDescription: {
	...
	onStart: async function ({ message, args, event, threadsData, role }) {
		...
		if (args.length === 0) {
			...
			msg += `░░░░█▄█ ▄▀█ ▀█ █▄▀ █▄█░░░
░░░░░█░ █▀█ █▄ █░█ ░█░░░░\n\n◦❭❯❱ 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 & 𝗖𝗔𝗧𝗘𝗚𝗢𝗥𝗬 ❰❮❬◦\n\n[.]𝖲 𝖠 𝖭 𝖭 𝖸•🅱🅾🆃↠ 𝐒𝐀𝐌_®`; // replace with your name 
			...
			msg += `☀︎︎ | ☻︎𝖲 𝖠 𝖭 𝖭 𝖸☻︎`; // its not decoy so change it if you want 
